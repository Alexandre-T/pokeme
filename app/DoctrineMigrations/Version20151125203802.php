 ...
 */
class Version20151125203802 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE te_vote_vot (vot_id BIGINT UNSIGNED AUTO_INCREMENT NOT NULL COMMENT \'Identifiant du classement\', user_id INT UNSIGNED DEFAULT NULL COMMENT \'Identifiant de l utilisateur\', site_id INT UNSIGNED DEFAULT NULL COMMENT \'Identifiant du site\', classement_id INT UNSIGNED DEFAULT NULL COMMENT \'Identifiant de l annuaire\', vot_creation DATETIME NOT NULL COMMENT \'Creation date\', vot_ip BIGINT NOT NULL COMMENT \'IP du voteur\', vot_tracker CHAR(36) NOT NULL COMMENT \'Tracker GGUID du voteur(DC2Type:guid)\', INDEX IDX_1FE60BA4A76ED395 (user_id), INDEX IDX_1FE60BA4F6BD1646 (site_id), INDEX IDX_1FE60BA4A513A63E (classement_id), INDEX i1_vote (vot_creation, classement_id, site_id), INDEX i2_vote (user_id, site_id, vot_creation), PRIMARY KEY(vot_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE te_validation_val (val_id INT UNSIGNED AUTO_INCREMENT NOT NULL COMMENT \'Identifiant de la validation\', validator_id INT UNSIGNED DEFAULT NULL COMMENT \'Identifiant de l utilisateur\', sit_raison TEXT DEFAULT NULL COMMENT \'Explication de la décision\', cla_statut SMALLINT DEFAULT 2 NOT NULL COMMENT \'Statut de l entité validée (refusé, en attente, accepté)\', new_creation DATETIME NOT NULL COMMENT \'Creation date\', new_update DATETIME DEFAULT NULL COMMENT \'Update date\', INDEX IDX_123B2B2B0644AEC (validator_id), PRIMARY KEY(val_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE te_site_sit (sit_id INT UNSIGNED AUTO_INCREMENT NOT NULL COMMENT \'Identifiant du site\', validation_id INT UNSIGNED DEFAULT NULL COMMENT \'Identifiant de la validation\', owner_id INT UNSIGNED DEFAULT NULL COMMENT \'Identifiant de l utilisateur\', sit_libelle VARCHAR(64) DEFAULT NULL COMMENT \'Titre du site\', sit_description MEDIUMTEXT DEFAULT NULL COMMENT \'Description du site\', sit_url VARCHAR(255) DEFAULT NULL COMMENT \'Url officiel du site\', new_creation DATETIME NOT NULL COMMENT \'Creation date\', new_update DATETIME DEFAULT NULL COMMENT \'Update date\', UNIQUE INDEX UNIQ_64475597FB1C8E1D (sit_url), UNIQUE INDEX UNIQ_64475597A2274850 (validation_id), INDEX IDX_644755977E3C61F9 (owner_id), INDEX i1_site (sit_libelle), PRIMARY KEY(sit_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tj_annuaire_site_ans (site_id INT UNSIGNED NOT NULL COMMENT \'Identifiant du site\', annuaire_id INT UNSIGNED NOT NULL COMMENT \'Identifiant de l annuaire\', INDEX IDX_995F4A6BF6BD1646 (site_id), INDEX IDX_995F4A6B5132B86A (annuaire_id), PRIMARY KEY(site_id, annuaire_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE te_annuaire_ann (ann_id INT UNSIGNED AUTO_INCREMENT NOT NULL COMMENT \'Identifiant de l annuaire\', validation_id INT UNSIGNED DEFAULT NULL COMMENT \'Identifiant de la validation\', owner_id INT UNSIGNED DEFAULT NULL COMMENT \'Identifiant de l utilisateur\', ann_libelle VARCHAR(64) NOT NULL COMMENT \'Nom de l annuaire\', ann_description MEDIUMTEXT DEFAULT NULL COMMENT \'Description de l annuaire\', ann_url VARCHAR(255) DEFAULT NULL COMMENT \'Url officiel du site diffusant l annuaire\', ann_creation DATETIME NOT NULL COMMENT \'Creation date\', ann_update DATETIME DEFAULT NULL COMMENT \'Update date\', UNIQUE INDEX UNIQ_2760D959A2274850 (validation_id), INDEX IDX_2760D9597E3C61F9 (owner_id), PRIMARY KEY(ann_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE te_validation_val ADD CONSTRAINT FK_123B2B2B0644AEC FOREIGN KEY (validator_id) REFERENCES te_user_usr (id)');
        $this->addSql('ALTER TABLE te_site_sit ADD CONSTRAINT FK_64475597A2274850 FOREIGN KEY (validation_id) REFERENCES te_validation_val (val_id)');
        $this->addSql('ALTER TABLE te_site_sit ADD CONSTRAINT FK_644755977E3C61F9 FOREIGN KEY (owner_id) REFERENCES te_user_usr (id)');
        $this->addSql('ALTER TABLE tj_annuaire_site_ans ADD CONSTRAINT FK_995F4A6BF6BD1646 FOREIGN KEY (site_id) REFERENCES te_site_sit (sit_id)');
        $this->addSql('ALTER TABLE tj_annuaire_site_ans ADD CONSTRAINT FK_995F4A6B5132B86A FOREIGN KEY (annuaire_id) REFERENCES te_annuaire_ann (ann_id)');
        $this->addSql('ALTER TABLE te_annuaire_ann ADD CONSTRAINT FK_2760D959A2274850 FOREIGN KEY (validation_id) REFERENCES te_validation_val (val_id)');
        $this->addSql('ALTER TABLE te_annuaire_ann ADD CONSTRAINT FK_2760D9597E3C61F9 FOREIGN KEY (owner_id) REFERENCES te_user_usr (id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE te_validation_val DROP FOREIGN KEY FK_123B2B2B0644AEC');
        $this->addSql('ALTER TABLE te_site_sit DROP FOREIGN KEY FK_644755977E3C61F9');
        $this->addSql('ALTER TABLE te_annuaire_ann DROP FOREIGN KEY FK_2760D9597E3C61F9');
        $this->addSql('ALTER TABLE te_site_sit DROP FOREIGN KEY FK_64475597A2274850');
        $this->addSql('ALTER TABLE te_annuaire_ann DROP FOREIGN KEY FK_2760D959A2274850');
        $this->addSql('ALTER TABLE te_vote_vot DROP FOREIGN KEY FK_1FE60BA4F6BD1646');
        $this->addSql('ALTER TABLE tj_annuaire_site_ans DROP FOREIGN KEY FK_995F4A6BF6BD1646');
        $this->addSql('ALTER TABLE te_vote_vot DROP FOREIGN KEY FK_1FE60BA4A513A63E');
        $this->addSql('ALTER TABLE tj_annuaire_site_ans DROP FOREIGN KEY FK_995F4A6B5132B86A');
        ...
        $this->addSql('DROP TABLE te_validation_val');
        $this->addSql('DROP TABLE te_site_sit');
        $this->addSql('DROP TABLE tj_annuaire_site_ans');
        $this->addSql('DROP TABLE te_annuaire_ann');
